...
class BasketServiceTest {
    ...
    void getUserBasketTest2() {
        ...
        Mockito.verify(storageService, Mockito.only()).getProductById(simpleProduct.getId());
        Mockito.verify(storageService, Mockito.only()).getProductById(simpleProduct1.getId());
        Mockito.verify(storageService, Mockito.only()).getProductById(simpleProduct2.getId());
        Mockito.verify(productBasket, Mockito.only()).getBasket();
    }
}
